...
export function GainModeHomeCard({ userId }: { userId: UUID }) {
  ...
  return (
    <section className="gc-daily-panel gc-home-gain-card overflow-hidden">
      <div className="flex items-center gap-3 px-4 py-3">
        <span className="gc-home-gain-icon grid h-9 w-9 shrink-0 place-items-center rounded-xl"><Sparkles className="h-4 w-4" /></span>
