-- Gym Crew recovered migration baseline.
-- Reconstructs the exact production public schema captured on 2026-07-22.
-- This is a history-recovery file for migration version 202607140001.
-- It does not claim to reproduce the original chronological SQL.
...
-- ---------------------------------------------------------------------------
-- Recovered auth.users bootstrap trigger
-- Verified against production on 2026-07-23.
-- The function public.handle_new_auth_user() is defined in the public baseline.
-- ---------------------------------------------------------------------------
